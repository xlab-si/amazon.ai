...
def create_agent_runtime_endpoint(
    ...
    response = client.create_agent_runtime_endpoint(**snake_dict_to_camel_dict(scrub_none_parameters(params)))
    ...
    if module.params.get("wait", True):
        wait_for_agent_runtime_endpoint_status(client, module, agent_runtime_id, endpoint_name_resp, "READY")
...
def update_agent_runtime_endpoint(
    ...
    # User has an option to wait for the endpoint to be ready, default is True
    if module.params.get("wait", True):
        wait_for_agent_runtime_endpoint_status(client, module, agent_runtime_id, updated_name, "READY")
