.. _amazon.ai.sagemaker_model_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Whether network isolation is enabled for the model.</div>
                </td>
            </tr>
            <tr>
                <td colspan="5">
            ...
            <tr>
                ...
                <td>
                        <div>The name of the model to manage.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Configuration for the model&#x27;s primary container.</div>
                        <div>Required when O(state=present).</div>
                </td>
            </tr>
                                <tr>
                ...
                <td>
                        <div>Environment variables to set in the container.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The path to the Docker image containing the inference code.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The location of the model artifacts.</div>
                        <div>Mutually exclusive with O(primary_container.model_data_url).</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Specifies the S3 location of the model artifacts.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>How the model artifacts are stored.</div>
                        <div>Use V(None) for uncompressed artifacts (works with both V(S3Object) and V(S3Prefix)).</div>
                        <div>Use V(Gzip) for a gzip-compressed TAR archive; only valid with V(S3Object).</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The ETag of the S3 object referenced by O(primary_container.model_data_source.s3_data_source.s3_uri).</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Configuration for access to a hub for the model artifacts.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The ARN of the hub content for the model.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>The ETag of the S3 object referenced by O(primary_container.model_data_source.s3_data_source.manifest_s3_uri).</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The S3 URI of the manifest file for the model artifacts.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Specifies the access configuration for the model artifacts.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Whether to accept the end-user license agreement for the model artifacts.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>The type of the S3 data source.</div>
                        <div>Use V(S3Object) when O(primary_container.model_data_source.s3_data_source.s3_uri) points to a single object.</div>
                        <div>Use V(S3Prefix) when it points to a key name prefix; the URI must end with a forward slash.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The S3 URI of the model artifacts.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>The S3 path where the model artifacts are stored.</div>
                        <div>Mutually exclusive with O(primary_container.model_data_source).</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Whether tags omitted from O(tags) should be removed.</div>
                </td>
            </tr>
            <tr>
                <td colspan="5">
            ...
            <tr>
                ...
                <td>
                        <div>The desired state of the model.</div>
                </td>
            </tr>
            <tr>
                <td colspan="5">
                ...
                <td>
                        <div>Tags to apply to the model.</div>
            ...
            <tr>
                ...
                <td>
                        <div>The VPC configuration for the model.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The VPC security group IDs.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>A dictionary containing the detailed configuration of the managed model.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>The date and time the model was created.</div>
                    <br/>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The ARN of the IAM role that SageMaker can assume to access model artifacts and docker image.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:iam::123456789012:role/SageMakerExecutionRole</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>The Amazon Resource Name (ARN) of the model.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:sagemaker:us-east-1:123456789012:model/example-model</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">example-model</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>The location of the primary docker image and container configuration.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">123456789012.dkr.ecr.us-east-1.amazonaws.com/example:latest</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>The S3 path where the model artifacts, including model weights and bias, are stored.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">s3://example-bucket/model.tar.gz</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">Model example-model created successfully.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                ...
                <td>when O(state=present)</td>
                <td>
                            <div>A dictionary containing the model tags.</div>
                    <br/>
                </td>
            </tr>
    </table>
