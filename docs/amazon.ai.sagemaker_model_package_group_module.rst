.. _amazon.ai.sagemaker_model_package_group_module:
...
**Manage Amazon SageMaker Model Package Groups**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The name of the model package group to manage.</div>
            ...
            <tr>
                ...
                <td>
                        <div>The desired state of the model package group.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Tags to apply to the model package group.</div>
...
.. seealso::
   ...
   :ref:`amazon.ai.sagemaker_model_package_group_info_module`
       Retrieve details for a single model package group or list matching groups.
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>A dictionary containing the managed model package group.</div>
                    <br/>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The current status of the model package group.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The tags assigned to the model package group.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
