.. _amazon.ai.bedrock_agentcore_runtime_module:
...
**Manage Amazon Bedrock AgentCore runtimes**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The name of the AgentCore runtime.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Audience values accepted by the custom JWT authorizer.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>authorizer_allowed_clients</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>
                ...
                <td>
                        <div>Client values accepted by the custom JWT authorizer.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>authorizer_allowed_scopes</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>
                ...
                <td>
                        <div>Scope values accepted by the custom JWT authorizer.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>authorizer_discovery_url</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <div>The discovery URL for the custom JWT authorizer.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>Configuration for a code-based runtime.</div>
                        <div>Required when O(state=present) unless O(container_configuration) is specified.</div>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The language runtime for the code configuration.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>The S3 object version identifier for the runtime code.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Configuration for a container-based runtime.</div>
                        <div>Required when O(state=present) unless O(code_configuration) is specified.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The URI of the container image for the runtime.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Environment variables supplied to the runtime.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>The idle runtime session timeout in seconds.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <b>Default:</b><br/><div style="color: blue">28800</div>
                </td>
                <td>
                        <div>The maximum runtime lifetime in seconds.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>The security groups for a VPC runtime.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>The subnets for a VPC runtime.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>The server protocol used by the runtime.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>The ARN of the IAM role assumed by AgentCore to run the runtime.</div>
            ...
            <tr>
                ...
                <td>
                        <div>The desired state of the AgentCore runtime.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>Tags attached to the runtime when it is created.</div>
                        <div>Tags cannot be modified after creation by this module.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Whether to wait for the requested operation to reach a terminal state.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>The maximum time in seconds to wait for an operation to complete.</div>
                </td>
            </tr>
    </table>
    <br/>
...
.. note::
   ...
   - The IAM actions are bedrock-agentcore:CreateAgentRuntime, bedrock-agentcore:GetAgentRuntime, bedrock-agentcore:UpdateAgentRuntime, bedrock-agentcore:DeleteAgentRuntime, and bedrock-agentcore:ListAgentRuntimes, plus iam:PassRole when a role is supplied.
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        ...
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;agent_runtime_arn&#x27;: &#x27;arn:aws:bedrock:us-east-1:123456789012:runtime/example&#x27;, &#x27;agent_runtime_id&#x27;: &#x27;example&#x27;, &#x27;agent_runtime_name&#x27;: &#x27;weather_runtime&#x27;, &#x27;status&#x27;: &#x27;READY&#x27;}</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>The ARN of the AgentCore runtime.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:bedrock:us-east-1:123456789012:runtime/example</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>The unique identifier of the AgentCore runtime.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">weather_runtime</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>The current status of the AgentCore runtime.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">Agent runtime weather_runtime created successfully.</div>
                </td>
            </tr>
    </table>
    <br/><br/>
