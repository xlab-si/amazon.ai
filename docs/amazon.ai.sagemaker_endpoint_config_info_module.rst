.. _amazon.ai.sagemaker_endpoint_config_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Only include configurations created after this time.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Only include configurations created before this time.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The endpoint configuration name to retrieve.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Maximum number of configurations to return.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>A substring in the endpoint configuration name.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
...
.. seealso::
   ...
   :ref:`amazon.ai.sagemaker_endpoint_config_module`
       Manage SageMaker endpoint configurations.
