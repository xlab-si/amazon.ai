.. _amazon.ai.sagemaker_model_info_module:
...
**Gather information about Amazon SageMaker Models**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Only include models created after this timestamp.</div>
                        <div>Ignored when O(model_name) is provided.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Only include models created before this timestamp.</div>
                        <div>Ignored when O(model_name) is provided.</div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The maximum number of models to return.</div>
                        <div>Ignored when O(model_name) is provided.</div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                        <div>The name of the model to retrieve.</div>
                        <div>If not provided, the module lists all models.</div>
            ...
            <tr>
                ...
                <td>
                        <div>A string that must be contained in the model name.</div>
                        <div>Ignored when O(model_name) is provided.</div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                        <div>A tag map to filter models by.</div>
                        <div>Only models whose tags contain all the given key/value pairs are returned.</div>
                        <div>Ignored when O(model_name) is provided.</div>
                </td>
            </tr>
            <tr>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>A list of dictionaries containing detailed configuration of Amazon SageMaker models.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The location of the primary docker image and container information.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>Environment variables set in the container.</div>
                    <br/>
                </td>
            </tr>
            <tr>
